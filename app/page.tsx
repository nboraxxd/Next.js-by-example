  ...
  return (
    <>
      ...
      <div className="group w-80 border rounded bg-white shadow transition-all hover:shadow-lg hover:-mt-[0.125rem] hover:mb-[0.125rem] md:w-full">
        <Link href="/reviews/stardew-valley" className="flex flex-col md:flex-row">
          <img
          ...
          />
          <h2 className="py-2 font-orbitron font-medium text-lg text-center md:grow">Stardew Valley</h2>
        </Link>
      </div>
    </>
  )
